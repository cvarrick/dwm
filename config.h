...
static const char selfgcolor[]      = "#9d9d9d";
...
static const char *termcmd[]  = { "mrxvt", "-stt", NULL };
static const char *screenlockcmd[]  = { "gdmflexiserver", "-a", NULL };
static const char *logout[]  = { "kill", "-9", "-1",  NULL };
static const char *volupcmd[]  = { "mpc",  "-h", "$MPD_HOST", "volume", "+5",  NULL };
static const char *voldowncmd[]  = { "mpc", "-h", "$MPD_HOST", "volume", "-5",  NULL };
static const char *volmutecmd[]  = { "/home/joneill/statusbar/toggle_mute.sh", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ ControlMask,                  XK_space,      spawn,          {.v = dmenucmd } }, { MODKEY|ShiftMask,             XK_q,      spawn,          {.v = screenlockcmd } },
	{ MODKEY,                  	XK_F4,      spawn,          {.v = volupcmd } },
	{ MODKEY,                  	XK_F3,      spawn,          {.v = voldowncmd } },
	{ MODKEY,                  	XK_F2,      spawn,          {.v = volmutecmd } },
	...
	TAGKEYS(                        XK_9,                      8)
	TAGKEYS(                        XK_grave,                  9)
	{ MODKEY|ControlMask|ShiftMask,             XK_q,      spawn,           {.v = logout} },
};
